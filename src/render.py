...
<header class="hero" id="top"><div class="wrap">
  ...
  <div class="byline">Built and reviewed by <b>Sachin Goyal</b> ·
    <a href="mailto:sachingoyal9274@gmail.com">sachingoyal9274@gmail.com</a> ·
    <a href="tel:+916280034162">(+91) 6280034162</a></div>
</div></header>"""
...
<section id="verification"><div class="wrap">
  ...
  <div class="acc-wrap">
    ...
    # ------------------------------------------------------------ run
    tree = """repo/
├─ <span class="d">data/</span>            <span class="c">apps.csv roster · verified.csv (final) · overrides.csv (labeled correction ledger) · research_drafts.csv (agent proposals) · audit_sample.csv (ground truth)</span>
...
│  ├─ mcp_sweep.py       <span class="c">official MCP registry sweep (mechanical evidence)</span>
│  ├─ build_corpus.py    <span class="c">seed + agent reports + MCP evidence → verified.csv</span>
│  ├─ make_overrides.py  <span class="c">labeled diff draft → verified (the human ledger)</span>
...
│  └─ run_all.py         <span class="c">one command, fourteen stages</span>
...
<footer><div class="wrap"><span>Generated by src/render.py from pipeline artifacts ·
  draft: {esc(draft_meta.get('model', 'n/a'))} · verified {today}<br>
  Sachin Goyal · <a href="mailto:sachingoyal9274@gmail.com">sachingoyal9274@gmail.com</a> ·
  <a href="tel:+916280034162">(+91) 6280034162</a></span>
