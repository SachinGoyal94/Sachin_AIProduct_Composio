...
STAGES = [
    ...
    (["mcp_sweep.py"], "MCP registry sweep (mechanical evidence)"),
    (["build_corpus.py"], "build verified corpus (reports + seed + sweeps)"),
    (["make_overrides.py"], "labeled diff draft -> verified (the human ledger)"),
    (["apply.py"], "apply promoted overrides -> pass 2"),
